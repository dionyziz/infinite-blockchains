...
\dionyziz{The above is false and there are counter examples: Parties can
continuously switch between disjoint ever-growing chains but have an empty
"eventual chain"; it needs to be proven as a separate property}
